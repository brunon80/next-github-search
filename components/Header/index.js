...
function Header({ isAuthenticated }) {
    ...
    return (
        <div className="p-2 flex flex-col justify-between items-center xl:flex-row lg:flex-row md:flex-row sm:flex-col w-full px-5">
            <Link href="/">
                <div className="flex align-middle items-center cursor-pointer">
                    <img className="" width={50} src="https://i.pinimg.com/originals/b1/5e/ed/b15eedbdafbbdbca3249e3942f4faf3b.png" alt="github logo" />
